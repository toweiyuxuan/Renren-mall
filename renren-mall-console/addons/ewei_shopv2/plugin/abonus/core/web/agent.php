	...
	public function check() 
	{
		...
		foreach ($members as $member ) 
		{
			...
			if ($status == 1) 
			{
				...
				{
					case '1': $aagentprovinces = (array) iunserializer($member['aagentprovinces']);
					case '2': $aagentcitys = (array) iunserializer($member['aagentcitys']);
					case '3': $aagentareas = (array) iunserializer($member['aagentareas']);
				}

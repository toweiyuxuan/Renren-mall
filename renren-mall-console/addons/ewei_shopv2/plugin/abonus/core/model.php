		...
		public function sendMessage($openid = '', $data = array(), $message_type = '') 
		{
			...
			if (($message_type == TM_ABONUS_PAY) && empty($usernotice['abonus_pay'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['aagent'] . '的' . $set['texts']['bonus'] . '已打款', 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => '区域代理分红发放通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的区域代理分红已发放', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
				}
				else 
				{
			...
			else if (($message_type == TM_ABONUS_UPGRADE) && empty($usernotice['abonus_upgrade'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，恭喜您升级为' . $data['newlevel']['levelname'], 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => '区域等级升级通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的区域代理等级从' . $data['oldlevel']['levelname'] . '升级为' . $data['newlevel']['levelname'] . '特此通知！', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
				}
				else 
				{
			...
			else if (($message_type == TM_ABONUS_BECOME) && empty($usernotice['abonus_become'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，恭喜您成为' . $aagenttype, 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => '成为区域代理通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您已成为' . $aagenttype, 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;

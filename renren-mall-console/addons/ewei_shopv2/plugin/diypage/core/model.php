							...
							else 
							{
								...
								else 
								{
									if( $item["id"] == "member" ) 
									{
										...
										$item["info"] = array( "avatar" => $member["avatar"], "nickname" => $member["nickname"], "levelname" => $member["levelname"], "textmoney" => $_W["shopset"]["trade"]["moneytext"], "textcredit" => $_W["shopset"]["trade"]["credittext"], "money" => $member["credit2"], "credit" => intval($member["credit1"]), "membercard" => count($list_membercard["list"]) );
									}
									else 
									{
										if( $item["id"] == "verify" ) 
